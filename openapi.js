var spec = {
	...
	externalDocs: {
		description:
			"Join Pricempire.com Discord server to get help at the #dev channel.",
	...
	paths: {
		...
		"/v2/items/prices": {
			get: {
				tags: ["Item"],
				summary:
					"FILTERED! by params. Getting all items in one response (API Key required)",
		...
		"/v3/items/structured": {
			get: {
				tags: ["Item"],
				summary: "Getting structured items data (API Key required)",
				description: "Getting structured items data ",
				operationId: "getItemsStructured",
				parameters: [
					{
						name: "page",
						in: "query",
		...
		"/v3/items/advanced": {
			get: {
				tags: ["Item"],
				summary:
					"Getting items advanced data (API Key & Enterprise plan required, 100mb+ data)",
			...
			get: {
				...
				parameters: [
					...
					},
					{
						...
						in: "query",
						description:
							"Days (7, 14, 30, 60, 90, 120, 180, Depends on your subscription)",
						required: false,
						schema: {
							type: "integer",
							format: "int(32)",
					...
					items: [
						{
							...
							type: "skin",
							sparkline: [
								311295, 319825, 319303, 317809, 316428, 317809, 315534, 315085,
								314806, 313475, 314792, 314123, 313939, 315582, 320720, 320389,
								318784, 315534, 314123, 320389, 315612, 315288, 314558, 309045,
								305264, 305447, 305454, 306215, 306632, 306424, 310785,
							],
							paintSeed: 865,
							weaponId: 523,
			...
			getPriceHistories: {
				...
				example: {
					"AK-47 | Elite Build (Field-Tested)": [
						149, 150, 150, 150, 150, 151, 151, 152, 152, 152, 154, 154, 155,
						156, 159, 147, 151, 154, 159, 160, 161, 162, 163, 164, 165, 166,
						167, 167,
					],
					"Sawed-Off | Amber Fade (Field-Tested)": [
						51, 51, 51, 51, 51, 52, 52, 52, 53, 56, 59, 60, 61, 61, 62, 55, 52,
						59, 62, 64, 61, 60, 60,
					],
					"Souvenir P90 | Schematic (Battle-Scarred)": [
						118, 118, 118, 118, 118, 118, 118, 118, 118, 118, 118, 118, 118,
						118, 118, 118, 118, 118, 118, 144, 144,
					],
					"USP-S | Forest Leaves (Factory New)": [
						117, 122, 122, 123, 128, 132, 133, 135, 135, 135, 132, 131, 130,
						128, 124, 110, 132, 132, 124, 123, 122, 120, 121, 122, 122,
					],
					"UMP-45 | Plastique (Battle-Scarred)": [
						72, 74, 74, 76, 79, 77, 77, 77, 77, 76, 74, 72, 71, 71, 71, 55, 77,
						74, 71, 59, 57, 56, 55, 53, 52, 51, 50, 49, 49,
					],
					"★ Butterfly Knife | Night (Field-Tested)": [
						84610, 83121, 82640, 82158, 81455, 82764, 82039, 81060, 80041,
						79128, 77577, 77168, 76430, 75889, 73874, 83808, 82764, 77577,
						73874, 73399, 73913, 73650, 73502, 74640, 74385, 74889, 74902,
						73799, 73737, 74307, 74307,
					],
					"StatTrak™ P250 | Muertos (Minimal Wear)": [
						1318, 1335, 1334, 1349, 1350, 1368, 1372, 1376, 1365, 1350, 1328,
						1323, 1312, 1312, 1297, 1240, 1368, 1328, 1297, 1292, 1279, 1263,
						1247, 1227, 1216, 1208, 1211, 1218, 1224, 1225, 1225,
					],
					"XM1014 | Blue Tire (Battle-Scarred)": [
						16, 17, 17, 17, 17, 17, 16, 17, 17, 17, 19, 19, 20, 20, 21, 17, 17,
						19, 21, 20, 21, 21,
					],
				},
			},
					...
					data: [
						{
							...
							type: "skin",
							item_type: "Covert Sniper Rifle",
							status: true,
							created_at: "2022-09-12T14:17:19.819Z",
							updated_at: "2023-08-21T17:20:19.331Z",
							meta: {
								slug: "awp-asiimov-field-tested",
								keywords: "awp | asiimov (field-tested)",
								like: 0,
								dislike: 0,
								image:
							...
							paint: {
								...
								paint_id: 279,
								weapon_id: 9,
								released: "2014-02-20T01:00:00.000Z",
								image:
									"https://steamcommunity-a.akamaihd.net/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgpot621FAR17PLfYQJD_9W7m5a0mvLwOq7c2G9SupUijOjAotyg3w2x_0ZkZ2rzd4OXdgRoYQuE8gDtyL_mg5K4tJ7XiSw0WqKv8kM",
								float_min: 0.18,
								float_max: 1,
								souvenir: false,
								stattrak: true,
							...
							connected_items: [
								...
								{
									market_hash_name: "StatTrak™ AWP | Asiimov (Well-Worn)",
									image:
										"-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgpot621FAR17PLfYQJD_9W7m5a0mvLwOq7c2G9SupUijOjAotyg3w2x_0ZkZ2rzd4OXdgRoYQuE8gDtyL_mg5K4tJ7XiSw0WqKv8kM",
									slug: null,
									price_from: 19128,
								...
								},
								{
									...
									image:
										"-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgpot621FAR17PLfYQJD_9W7m5a0n_L1JaKfzzoGuJJ02e2W8d6m2gztrkRoZmigItDGcgA_N1iFqwC-xr_m1J-57YOJlyVerprbwA",
									slug: null,
									price_from: 7773,
								},
								{
								...
								{
									market_hash_name: "StatTrak™ AWP | Asiimov (Battle-Scarred)",
									image:
										"-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgpot621FAR17PLfYQJD_9W7m5a0n_L1JaKfzzoGuJJ02e2W8d6m2gztrkRoZmigItDGcgA_N1iFqwC-xr_m1J-57YOJlyVerprbwA",
									slug: null,
									price_from: 12917,
							...
							stats: {
								...
								"52_week_high": 966305,
								count: "120596",
								marketcap: 1389265920,
								"30d_prev_exists": "119895",
								avg_price: null,
								liquidity: "1",
								currently_listed: 24526,
								steam_volume: 22,
								d7_trades: 3884,
								marketcap7d: "1474708500",
							},
						},
					],
				},
					...
					data: [
						{
							...
							slug: "awp-asiimov-battle-scarred",
							supply: 6575,
							sticker_amount: 4,
							weapon_id: 9,
							paint_id: 279,
